...
/**
 * Apeex's REST API URL mappings and endpoint security configuration.
 */
public interface ApeexApiService {

    // General endpoints
    @GET("/openapi/quote/v1/ping")
    @Headers(ApeexConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    Call<Void> ping();
